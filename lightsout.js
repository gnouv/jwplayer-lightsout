...
(function(jwplayer) {
	...
	function main(player, config, div) {
		...
		function setup(e) {
			...
			var fragment = createDOM('<div title="Turn Light on" class="jw-icon jw-icon-inline jw-button-color jw-reset jw-icon-light"><i aria-hidden="true" class="fa fa-lightbulb-o"></i></div>');
	...
	function Lights(element, time, dark, callback) {
		...
		this.on = function() {
			...
			light_toggle.className = light_toggle.className.replace(/\bjw-toggle\b/, '');
